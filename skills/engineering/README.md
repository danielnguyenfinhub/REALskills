...
- **[review-diff](./review-diff/SKILL.md)** — Disciplined self-review of the current change before it ships: read the diff against the domain model, judge correctness then design, and rank findings by what blocks the commit.
